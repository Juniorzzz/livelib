...
import com.example.unityandroidlive.encodec.BaseMediaEncoder;
import com.example.unityandroidlive.encodec.VideoEncodeRecode;
            ...
            try {
                ...
                while ((size = inputStream.read(buffer, 0, bufferSize)) != -1) {
                    ...
                    if (reference.get().videoEncodeRecode == null || isExit) {
                        Log.e("pest", "videoEncodeRecode == null or isExit-->  break");
                        break;
                    }
